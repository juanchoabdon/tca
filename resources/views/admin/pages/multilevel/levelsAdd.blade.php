    ...
    <div class="col-md-8 col-md-offset-2">
   	<div class="panel panel-default">
            <div class="panel-body">
                ...
                <input type="number" class="form-control" name="active_membres" >
                <br>
              <!--  <label>Prsv</label>
                <input type="number" class="form-control" name="prsv">
                <br> -->
                <label>Recompensa</label>
                <input type="number" class="form-control" name="recompensa">
                <br>
                <label>G.V</label>
                <input type="number" class="form-control" name="group_volume" >
                <br>
                <center>
