...
<div id="main">
	<div class="page-header">
		...
		<div class="pull-right">
			...
			<a href="{{URL::to('admin/multinivel/comisiones')}}" class="btn btn-primary">Rangos</i></a>
		</div>
		<h2>Equipos</h2>
	</div>
            ...
            @foreach($networkers as $networker)
                ...
                <div class="btn-group">
								...
								<ul class="dropdown-menu dropdown-menu-right" role="menu">
									<li><a href="{{ url('/admin/multilevel/edit/'.$networker->id) }}"><i class="md md-edit"></i> Editar</a></li>
									<li><a href="{{ url('/admin/multinivel/team/'.$networker->id) }}"><i class="md md-edit"></i> Equipo</a></li>
