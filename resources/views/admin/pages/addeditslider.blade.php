            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="name" value="{{ isset($slide->name) ? $slide->name : null }}" class="form-control">
								...
								<div class="form-group">
                    <label for="" class="col-sm-3 control-label">Contenido</label>
                    <div class="col-sm-9">
											<textarea name="text" rows="8" class="form-control" id="summernote">{{ isset($slide->text) ? $slide->text : null }}</textarea>
                    </div>
                </div>
				<div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($slide->name) ? 'Editar ' : 'Añadir ' }}</button>
