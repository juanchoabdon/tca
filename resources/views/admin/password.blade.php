...
<span aria-hidden="true">&times;</span></button>
				...
				@endif
                       ...
                       <div class="form-group">
                            <a href="{{ URL::to('login') }}" class="small pull-right">Ingresar?</a>

                        </div>

                    </div>
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-primary" style="background-color: #fcf7e6;
    border-color: #fcf7e6; color: #a87e00;
"> Enviar Correo<i class="md md-lock-open"></i></button>
                    </div>
                {!! Form::close() !!}
            </div>
