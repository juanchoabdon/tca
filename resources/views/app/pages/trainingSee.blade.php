...
<div class="content">
			<h2 class="content-heading">{{$training->title}} - {{$content->titulo}}</h2>
   ...
   @foreach($contents as $video)
    		@if($content->id != $video->id)
 	 				<div class="col-md-6 col-xl-3">
 						<a class="block block-rounded block-link-pop text-center" href="/app/entrenamiento/ver/{{$video->id}}">
 								...
 								<div class="block-content block-content-full">
 										<div class="font-w600 mb-5">{{$video->titulo}}</div>
 										<!-- <div class="font-size-sm text-muted">  {!! $video->descripcion !!}</div> -->
 								</div>
 						</a>
 		      </div>
			@endif
