...
@section("content")
	...
	<div class="content">
				<h2 class="content-heading">Análisis Semanales</h2>
...
<div class="panel panel-default panel-shadow">
    <div class="panel-body">
		  ...
		  <a href="/app/analisis/ver/{{$analisi->id}}" style="outline: 0;text-decoration: none;color: black;">
			...
			<div class="row">
				<div class="col-12 col-md-12 col-xl-12 offset-md-5">
					 ...
					 <a class="block block-link-shadow text-center" href="javascript:void(0)">
						 ...
						 <p class="font-w600">Próximamente encontrarás análisis que te ayudarán a ser un trader profesional</p>
					 </div>
				 </a>
			 </div>
