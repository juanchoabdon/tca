              ...
              <div class="block">
                  <ul class="nav nav-tabs nav-tabs-alt" data-toggle="tabs" role="tablist">
                      ...
                      <li class="nav-item"  onclick="location.href = '/app/autotrading/settings' ">
                          <a class="nav-link" href="#configuration">Configuración</a>
                      </li>
                      <li class="nav-item" onclick="location.href = '/app/autotrading/account' "  >
                          <a class="nav-link active">Cuenta</a>
                      </li>
                  </ul>
                  ...
                  <div class="block-content tab-content">
                      ...
                      <div class="tab-pane" id="configuration" role="tabpanel">
                        ...
                        <div class="tab-pane active" id="account" role="tabpanel">
                               ...
                               <div class="block">
                    <div class="block-content">
                        {!! Form::open(array('url' => 'app/autotrading/account','class'=>'form-horizontal padding-15','mt4_login'=>'mt4_login','mt4_password' => 'mt4_password','mt4_server' => 'mt4_server')) !!}

                        <form method="post" onsubmit="return false;">
                            <div class="form-group">
                                <label for="example-nf-email">Metatrader 4 Login</label>
                                <input type="text"  value="{{ Auth::user()->mt4_login }}" class="form-control" id="mt4_login" name="mt4_login" required>
                            </div>
                            <div class="form-group">
                                <label for="example-nf-password">Metatrader 4 Password</label>
                                <input type="password" value="{{ Auth::user()->mt4_password }}" class="form-control" id="mt4_password" name="mt4_password" required>
                            </div>
                            <div class="form-group">
                                <label for="example-nf-email">Metatrader 4 Server</label>
                                <input type="text"  value="{{ Auth::user()->mt4_server }}" class="form-control" id="mt4_server" name="mt4_server" autocomplete="off" required>
                            </div>
                            <br>
