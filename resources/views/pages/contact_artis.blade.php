                 ...
                 <div class="contact-form-3-text">
                    ...
                    <div class="address-area">
                       <div class="view-location">
                          <h2>Direccion :</h2>
                          <p><i class="fa fa-map-marker"></i>{{getcong('site_address')}} </p>
                       </div>

                          <div class="address-details">
                              <h2>Email :</h2>
                           <span><i class="fa   fa-envelope"></i>{{getcong('site_email')}} </span>
                          </div>
                       ...
                       <div class="row">
                          ...
                          <div class="address-details">
                              <h2>Telefonos :</h2>
                              <span><i class="fa  fa-phone"></i> {{getcong('site_phone')}} </span>
                          </div>
                 ...
                 <div class="contact-form-left contact-form-3 contact-form-right">
                    ...
                    <div class="result_message"></div>
                       ...
                       <div class="row">
                          ...
                          <div class="col-sm-6">
                              <input type="text" name="subject" class="form-control" id="Subject" placeholder="Sujeto">
                          </div>
                          <div class="col-sm-12">
                              <textarea name="user_message" class="form-control" rows="3" id="Message"  placeholder="Mensaje"></textarea>
                          </div>
                          <div class="col-sm-12 text-center">
                             <button type="submit" name="submit" class="btn btn-dm">Enviar</button>
                          </div>
                       </div>
                  {!! Form::close() !!}
                 </div>
