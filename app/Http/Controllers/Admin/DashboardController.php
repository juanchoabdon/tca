...
class DashboardController extends MainAdminController
{
    ...
    public function index()
    {
    	...
    	{
			$student_count = User::where('usertype','=','Estudiante')->count();
			$teacher_count = User::where('usertype','=','Profesor')->count();
        ...
        return view('admin.pages.dashboard',compact('student_count','teacher_count','inquiries','agents','testimonials','subscriber','partners','publish_properties','unpublish_properties'));
    }
